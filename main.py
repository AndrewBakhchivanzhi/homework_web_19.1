                        ...
                        <p class="d-inline-flex gap-1">
                            ...
                            <div class="collapse" id="collapseExample">
                                <div class="card card-body">
                                    Через торговых представителей или в магазинах розничной торговли
                                </div>
                            </div>
                            <div class="collapse" id="collapseExample2">
                                <div class="card card-body">
                                    Курьером или отделом почты
                                </div>
                            </div>
                            <div class="collapse" id="collapseExample3">
                                <div class="card card-body">
                                    Гарантия 2 года при соблюдении инструкции по эксплуатации
                                </div>
                            </div>
        </main>
...
"""
    ...
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(bytes(self.__get_html(), "utf-8"))
